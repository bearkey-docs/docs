---
sidebar_position: 3
sidebar_label: "三、RK3568 平台界面功能使用及测试"
title: "RK3568 OpenHarmony 系统用户手册 - 三、RK3568 平台界面功能使用及测试"
generated_from_split_doc: openharmony/rk3568-main-board/RK3568_Lite_board
editUrl: false
---
...
![image-20260708150803469](../images/image-20260708150803469.webp)

![image-20260708151009193](../images/image-20260708151009193.webp)
...
1. 确认蓝牙天线已正确连接；
   ...
   ![image-20260708151529834](../images/image-20260708151529834.webp)
...
8. 确认连接成功。
   ...
   ![image-20260708151407630](../images/image-20260708151407630.webp)
...
2. 插入耳机；
   ...
   ![image-20260708151642135](../images/image-20260708151642135.webp)

3. 打开系统桌面的音乐播放器；

   ![image-20260708151839680](../images/image-20260708151839680.webp)
...
3. 找到板子丝印标有MIC位置，安装好硬件
   ...
   ![image-20260708152319629](../images/image-20260708152319629.webp)

4. 点击打开应用后，点击录音，录音完毕后，点击播放，插上耳机或扬声器，

   ![image-20260708152130992](../images/image-20260708152130992.webp)
...
2. 确认排线方向和接口连接正确；
   ...
   ![image-20260708152451961](../images/image-20260708152451961.webp)
...
​	![image-20260708152655778](../images/image-20260708152655778.webp)
