...
generated_from_split_doc: terminal/rk3568-data-acquisition-gateway/wiki-tutorial-openharmony
editUrl: false
---


# 第三章 RK3568 平台界面功能使用及测试
...
![桌面](../wiki-tutorial-openharmony-assets/3.1.webp)
...
6. 输入密码并点击连接；
   ...
   ![15](../wiki-tutorial-openharmony-assets/3.2.webp)
...
![485 接口](../wiki-tutorial-openharmony-assets/z3.0.webp)

测试工具介绍：

1. 485串口测试工具

   ![17](../wiki-tutorial-openharmony-assets/3.3.webp)

2. 232串口测试工具

   ![18](../wiki-tutorial-openharmony-assets/3.4.webp)

3. PC端串口助手

   ![19](../wiki-tutorial-openharmony-assets/3.5.webp)
...
![u3](../wiki-tutorial-openharmony-assets/z3.2.webp)
...
![j1.2](../wiki-tutorial-openharmony-assets/j1.2.webp)
...
![j1.3](../wiki-tutorial-openharmony-assets/j1.3.webp)
...
![u4](../wiki-tutorial-openharmony-assets/z3.1.webp)
...
![j1.4](../wiki-tutorial-openharmony-assets/j1.4.webp)
...
1. 232串口测试工具
   ...
   ![1](../wiki-tutorial-openharmony-assets/j1.5.webp)

2. PC端串口助手

   ![19](../wiki-tutorial-openharmony-assets/j1.0.webp)
...
![z3.3](../wiki-tutorial-openharmony-assets/z3.3.webp)
...
![j1.1](../wiki-tutorial-openharmony-assets/j1.1.webp)
...
![j1.8](../wiki-tutorial-openharmony-assets/j1.8.webp)
...
![z3.4](../wiki-tutorial-openharmony-assets/z3.4.webp)
...
![j2.0](../wiki-tutorial-openharmony-assets/j2.0.webp)
...
![USB 鼠标测试](../wiki-tutorial-openharmony-assets/3.6.webp)
...
![蓝牙连接](../wiki-tutorial-openharmony-assets/3.7.webp)
...
1. 找到开发板上丝印标识为 `PHONE` 的接口；
   ...
   ![耳机接线图](../wiki-tutorial-openharmony-assets/Z3.5.webp)

2. 插入耳机；

3. 打开桌面音乐播放器；

   ![音乐播放器](../wiki-tutorial-openharmony-assets/3.8.webp)
