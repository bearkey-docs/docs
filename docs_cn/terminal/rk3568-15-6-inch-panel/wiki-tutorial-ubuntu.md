...
sidebar_position: 2
split_by_h2: true
slug: /_split-source/terminal/rk3568-15-6-inch-panel/wiki-tutorial
unlisted: true
...
RK3568工控屏面向工业控制、边缘计算、设备网关等应用场景，提供 RS485、RS232、DI/DO、USB、RTC、Wi-Fi、以太网、SSD、SATA、CAN等常用工业接口。
